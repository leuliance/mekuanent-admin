import { R as Range, E as Editor, S as Scrubber, a as Element, T as Transforms, N as Node, b as Text, P as Path, c as Point } from "./slate.mjs";
import { l as libExports } from "./is-hotkey.mjs";
...
var create = (key) => {
  ...
  var isGeneric = generic && libExports.isHotkey(generic);
  var isApple = apple && libExports.isHotkey(apple);
  var isWindows = windows && libExports.isHotkey(windows);
  return (event) => {
...
var _excluded = ["anchor", "focus"], _excluded2 = ["anchor", "focus"];
...
export {
  normalizePoint as $,
  isDOMElement as A,
  EDITOR_TO_SCHEDULE_FLUSH as B,
  CAN_USE_DOM as C,
  DOMEditor as D,
  EDITOR_TO_FORCE_RENDER as E,
  NODE_TO_INDEX as F,
  NODE_TO_PARENT as G,
  HAS_BEFORE_INPUT_SUPPORT as H,
  IS_FIREFOX as I,
  isTrackedMutation as J,
  EDITOR_TO_PENDING_DIFFS as K,
  applyStringDiff as L,
  MARK_PLACEHOLDER_SYMBOL as M,
  NODE_TO_ELEMENT as N,
  isDOMSelection as O,
  PLACEHOLDER_SYMBOL as P,
  EDITOR_TO_PENDING_SELECTION as Q,
  EDITOR_TO_PENDING_ACTION as R,
  targetRange as S,
  TRIPLE_CLICK as T,
  verifyDiffState as U,
  splitDecorationsByChild as V,
  withDOM as W,
  EDITOR_TO_PLACEHOLDER_ELEMENT as X,
  normalizeStringDiff as Y,
  mergeStringDiffs as Z,
  normalizeRange as _,
  isTextDecorationsEqual as a,
  EDITOR_TO_KEY_TO_ELEMENT as a0,
  Key as a1,
  EDITOR_TO_ON_CHANGE as a2,
  IS_READ_ONLY as b,
  IS_NODE_MAP_DIRTY as c,
  IS_WEBKIT as d,
  IS_ANDROID as e,
  getSelection as f,
  getActiveElement as g,
  IS_FOCUSED as h,
  isElementDecorationsEqual as i,
  getDefaultView as j,
  EDITOR_TO_WINDOW as k,
  EDITOR_TO_ELEMENT as l,
  ELEMENT_TO_NODE as m,
  containsShadowAware as n,
  EDITOR_TO_USER_SELECTION as o,
  IS_COMPOSING as p,
  EDITOR_TO_PENDING_INSERTION_MARKS as q,
  isPlainTextOnlyPaste as r,
  hotkeys as s,
  IS_CHROME as t,
  IS_FIREFOX_LEGACY as u,
  IS_IOS as v,
  IS_WECHATBROWSER as w,
  IS_UC_MOBILE as x,
  EDITOR_TO_USER_MARKS as y,
  isDOMNode as z
};

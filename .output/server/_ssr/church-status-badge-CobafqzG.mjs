...
const statusConfig = {
  ...
  rejected: {
    label: "Rejected",
    className: "bg-red-50 text-red-700 ring-red-600/20 dark:bg-red-900/20 dark:text-red-400 dark:ring-red-400/20"
  },
  suspended: {
    label: "Suspended",
    className: "bg-slate-50 text-slate-700 ring-slate-600/20 dark:bg-slate-900/20 dark:text-slate-400 dark:ring-slate-400/20"
  }
};

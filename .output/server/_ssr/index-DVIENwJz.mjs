...
function ChurchDetailError({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-md", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-2", children: "Failed to Load Church" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", render: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/churches", search: {
        status: void 0,
        category: void 0,
        page: 1,
        search: void 0
...
export {
  ChurchDetailError as errorComponent
};

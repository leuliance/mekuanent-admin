...
import { createBankAccount, updateBankAccount } from "@/api/churches";
...
import { getLocalizedText } from "@/stores/locale-store";
...
export function BankAccountDialog({
	...
	const form = useForm({
		defaultValues: {
			bank_name: editAccount ? getLocalizedText(editAccount.bank_name) : "",
